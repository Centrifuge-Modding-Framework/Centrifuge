...
namespace Reactor.API.GTTOD.Transpilers
{
    internal static partial class WeaponScript
    {
        private static class PrimaryFire
        {
            ...
            {
                var methodInfo = typeof(global::WeaponScript).GetNestedType("<PrimaryFire>d__129", BindingFlags.NonPublic).GetMethod("MoveNext", BindingFlags.NonPublic | BindingFlags.Instance);
